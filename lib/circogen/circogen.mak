...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "." /I "..\.." /I "..\common" /I "..\neatogen" /I "..\gvc" /I "..\pack" /I "..\gd" /I "..\cdt" /I "..\graph" /I "..\pathplan" /D "NDEBUG" /D "WIN32" /D "_MBCS" /D "_LIB" /D "MSWIN32" /D "HAVE_CONFIG_H" /Fp"$(INTDIR)\circogen.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
BSC32=bscmake.exe
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\circogen.lib"
   copy .\Release\circogen.lib ..\lib\Release
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /ZI /Od /I "." /I "..\.." /I "..\common" /I "..\neatogen" /I "..\gvc" /I "..\pack" /I "..\gd" /I "..\cdt" /I "..\graph" /I "..\pathplan" /D "_DEBUG" /D "WIN32" /D "_MBCS" /D "_LIB" /D "MSWIN32" /D "HAVE_CONFIG_H" /Fp"$(INTDIR)\circogen.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\circogen.bsc" 
BSC32_SBRS= \
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\circogen.lib"
   copy .\Debug\circogen.lib ..\lib\Debug
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"
