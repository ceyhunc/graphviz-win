...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\common" /I "." /I "..\.." /I "..\pathplan" /I "..\graph" /I "..\cdt" /I "..\neatogen" /I "..\gvc" /D "NDEBUG" /D "WIN32" /D "_MBCS" /D "_LIB" /D "MSWIN32" /D "HAVE_CONFIG_H" /Fp"$(INTDIR)\pack.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
BSC32=bscmake.exe
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\pack.lib"
   copy .\Release\pack.lib ..\lib\Release
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /ZI /Od /I "..\common" /I "." /I "..\.." /I "..\pathplan" /I "..\graph" /I "..\cdt" /I "..\neatogen" /I "..\gvc" /D "_DEBUG" /D "WIN32" /D "_MBCS" /D "_LIB" /D "MSWIN32" /D "HAVE_CONFIG_H" /Fp"$(INTDIR)\pack.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\pack.bsc" 
BSC32_SBRS= \
